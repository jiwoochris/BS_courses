...
window.onload = function init()
{
    ...
    document.getElementById( "Button1" ).onclick = function () {radius *= 1.1;};
    document.getElementById( "Button2" ).onclick = function () {radius *= 0.9;};
...
function render()
{
    ...
    myMatrix = lookAt(eye, at, up);

    gl.uniformMatrix4fv(modelView, false, flatten(myMatrix));
